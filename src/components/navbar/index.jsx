  ...
  return (
    <NavbarContainer useTransparent={useTransparent}>
      ...
      <AccessibilityContainer>
        <NavItem>
          {!isMobile && <AnchorLink to="/#">Specialists Portal</AnchorLink>}
          {!isMobile && <Marginer direction="horizontal" margin={10} />}
          {!isMobile && <Seperator />}
          {!isMobile && <AnchorLink to="/#">Discover</AnchorLink>}
          {!isMobile && <Marginer direction="horizontal" margin={10} />}
          {!isMobile && <Seperator />}
          {!isMobile && <AnchorLink to="/#">About Us</AnchorLink>}
          {!isMobile && <Marginer direction="horizontal" margin={10} />}
          {!isMobile && <Seperator />}
          {!isMobile && <AnchorLink to="/#">Contact Us</AnchorLink>}
          {!isMobile && <Marginer direction="horizontal" margin={10} />}
          {!isMobile && <Seperator />}
